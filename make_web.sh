...
CC="em++"
CFLAGS="-O3 -std=c++14 --bind -lpthread -s DISABLE_EXCEPTION_CATCHING=0 -s WASM=1 -s USE_SDL=1 -s USE_SDL_IMAGE=1 -s STB_IMAGE=1 -s LEGACY_GL_EMULATION=1 -s GL_UNSAFE_OPTS=0"
